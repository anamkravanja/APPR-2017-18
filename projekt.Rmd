...
print(napoved)
```
Izboljšanje razmer na trgu dela se kažejo tudi v povečanju plač. Rast povprečne bruto plače v zasebnem sektorju je spodbujena z gospodarsko rastjo in s tem povezanimi dobrimi rezultati. Plače so torej višje skozi leta, linerani model nam napoveduje torej nadaljno rast.
...
Pri prvem prikazu opazujemo plače v Sloveniji glede na regijo, jasno je vidno, da je v povprečju najvišja plača v osrednjeslovenski regiji, najnižja pa v prekmurju. Skozi leta se nekoliko viša, vendar razmerje med regijami ostaja približno enako. 
...
Zato si sedaj natančneje poglejmo odvisnost izdatkov in minimalnih plač.
